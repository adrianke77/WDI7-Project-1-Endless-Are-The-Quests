...
WorldBoard.prototype.winScreen = function () {
  $( document ).off();
  $( ".winscreen" ).removeClass( "hidden" ).addClass( "winanim" );
  $( ".winscreen" ).text(
    "You have secured new peace for the land; unfortunately you will become the next Fallen Knight within two decades. Then another hero must rise to save the land. \n\nFrom you."
  );
  $( ".defense" ).text( "Click here to pass twenty years.. " );
  $( ".defense" ).click( function () {
    location.reload()
  } )
}
